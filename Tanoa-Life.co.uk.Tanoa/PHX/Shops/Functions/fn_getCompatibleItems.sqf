/*
	@File: fn_getCompatibleItems.sqf
	@Author: Jack "Scarso" Farhall
	@Description: Gets the compatible items for our gear...
*/
...

{
    ...
    if (isClass (_cfg >> "weaponSlotsInfo" >> _x >> "compatibleItems")) then {
        private _secondMethodDefinedAttachments = configProperties [_cfg >> "weaponSlotsInfo" >> _x >> "compatibleItems", "((getNumber _x) isEqualTo 1)", true];
        {
