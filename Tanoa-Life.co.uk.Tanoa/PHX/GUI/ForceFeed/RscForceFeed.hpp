class RscForceFeed {
	idd = 2900;
	name = "RscForceFeed";
  	onLoad = "['loadUI'] spawn PHX_fnc_forceFeed;";
    ...
    class Controls{
        ...
        class Force:Life_RscButton{
            idc = -1;
            onButtonClick = "['forceFeed', life_pInact_curTarget, lbData [2902, lbCurSel 2902]] spawn PHX_fnc_forceFeed; closeDialog 0;";
			x = safeZoneX + safeZoneW * 0.46375;
