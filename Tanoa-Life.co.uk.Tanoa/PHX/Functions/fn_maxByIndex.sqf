/*
*   @File: fn_maxByIndex.sqf
*   @Author: Sig
*
*   Description: Selects the highest (max) array based on the given index
*   of the array
*
*   Arguments
...
*
*     Returns the second element ([player 3, damage player3]) as that element has the lowest number (0.7) at the given index (1)
*
*   Return
*     <TYPE: ARRAY> Selected element with highest value
*/
