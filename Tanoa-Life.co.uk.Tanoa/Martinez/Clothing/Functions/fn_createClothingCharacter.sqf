/*
	File: fn_createClothingCharacter.sqf
	Function: Martinez_fnc_createClothingCharacter
	Author: Martinezzz
...
switch (_type) do {
	case "Create": {
		...
		_display setVariable ["Martinez_ClothingCharacter", _tempObj];
	};
	...
	case "Delete": {
		...
		_display setVariable ["Martinez_ClothingCharacter", nil];
	};
};
