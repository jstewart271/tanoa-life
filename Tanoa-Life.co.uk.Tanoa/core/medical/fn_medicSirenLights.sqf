...
if !(typeOf _vehicle in ["C_Hatchback_01_F","C_SUV_01_F","C_Offroad_02_unarmed_F","C_Van_02_medevac_F","C_Hatchback_01_sport_F"]) exitWith {}; //Last chance check to prevent something from defying humanity and creating a monster.
