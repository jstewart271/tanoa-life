                        ...
                        if (_ispack) then {
                            ...
                            if (_ongun) then {
                                ...
                                if (_override) then {
                                    ...
                                    if (_slotTaken) then {
                                        _action = ["Do you want to add this item to your weapon or inventory? If you add it to your weapon your current existing attachment will be lost!","Attachment slot taken!","Weapon","Inventory"] call PHX_fnc_confirmBox;
                                        if (_action) then {
                                            switch (_type) do {
                                                case 1: {player addPrimaryWeaponItem _item;};
                                                case 2: {player addSecondaryWeaponItem _item;};
